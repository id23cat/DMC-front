import { InputControl, InputControlProps, InputControlValue } from "../controls/inputControl";
...
export const FormInput = makeFormControl<InputControlProps, InputControlValue>(InputControl);
